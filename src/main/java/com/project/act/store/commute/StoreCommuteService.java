...
public interface StoreCommuteService {

	List<CommuteDTO> getCommuteList(Map map) throws SQLException;
	List<EmployeeDTO> getEmpList(String user_id) throws SQLException;
	...
	long list_count(String store_name)throws SQLException;
