...
public interface HeadGoalService {

	void headGoalInsert(Monthly_goalDTO monthly_goalDTO) throws Exception;

	StoresDTO getStore(String store_name)throws Exception;
	...
	List<Monthly_goalDTO> getGoalList(Monthly_goalDTO monthly_goalDTO) throws Exception;
