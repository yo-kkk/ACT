		...
		success : function(data) {			
			...
			for(let i=0;i<data.length;i++){
				...
				ref+=data[i].productDTO.product_code;
		       	ref+= '</td>';
		       	ref+= '<td id="'+ data[i].productDTO.factoryDTO.factory_code+'">'+ data[i].productDTO.factoryDTO.factory_name +'</td>';	
				ref+= '<td id="q_'+i+'">'+data[i].quantity+'</td>';
				ref+= '<td id="p_'+i+'">'+data[i].productDTO.price+'</td>'
			...
			let pagebtn ='';
				...
				pagebtn+='		  <ul class="pagination" style="justify-content: center;">    ';
